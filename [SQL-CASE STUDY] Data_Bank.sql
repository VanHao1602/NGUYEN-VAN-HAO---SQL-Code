...
Select a.region_id, b.region_name, Count(node_id) as node_count
From dbo.customer_nodes a
Join dbo.regions b
...
Select a.region_id, b.region_name, Count(Distinct customer_id) as customer_count
From dbo.customer_nodes a
Join dbo.regions b
On a.region_id = b.region_id
Group by a.region_id, b.region_name
...
Select round(avg(datediff(day, start_date, end_date)), 2) as avg_change_node_days
From customer_nodes
...
Select top 5 * From dbo.customer_nodes
Select top 5 * From dbo.customer_transactions
Select top 5 * From dbo.regions
...
With avg_deposit as (
  Select customer_id, txn_type, Count(*) as deposit_count, Sum(txn_amount) as deposit_amount
  From dbo.customer_transactions
